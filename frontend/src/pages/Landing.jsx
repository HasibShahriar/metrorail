        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="px-5 py-2 rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-50 transition-all duration-200"
              style={{ fontSize: "0.9rem", fontWeight: 500 }}
            >
              Sign Up
            </button>
          ...
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="pt-2 flex flex-col gap-2">
              <button
                ...
                className="w-full py-2.5 rounded-lg border border-blue-600 text-blue-600 hover:bg-blue-50 transition-colors"
              >
                Sign Up
              </button>
              <button
                ...
                className="w-full py-2.5 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors"
              >
                Sign In
              </button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center py-16 lg:py-24">
          ...
          <div className="relative z-10">
            ...
            >
              Smart Metro Rail <span className="text-blue-300">Ticketing</span>{" "}
              &{" "}
    ...
    <section id="features" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          >
            Our comprehensive metro management platform provides all the tools
            for a seamless commuting experience — from booking to boarding.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p
            ...
            style={{ fontSize: "1rem", lineHeight: 1.7 }}
          >
            Getting from point A to point B has never been easier. Follow these
            simple steps to plan and book your metro journey.
          </p>
        </div>
                      ...
                      {HOW_IT_WORKS_STEPS.map((_, i) => (
                        <div
                          ...
                          className={`w-1.5 h-1.5 rounded-full transition-colors ${
                            i === index ? item.iconBg : "bg-gray-200"
                          }`}
                        />
                      ))}
                    </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p
                    ...
                    style={{
                      fontSize: "0.68rem",
                      fontWeight:
                        i === 0 || i === METRO_STATIONS.length - 1 ? 700 : 400,
                    }}
                  >
                    {station}
                  </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p
            ...
            style={{ fontSize: "1rem", lineHeight: 1.7 }}
          >
            Our platform serves millions of passengers every day, connecting
            communities across the metropolitan area with reliable rail transit.
          </p>
        </div>
